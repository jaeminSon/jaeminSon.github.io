...
- (기출) 건폐율, 용적률
    ...
    - 상업지역
        ...
        - 근(린): 출 (7) 900
    - 공업지역
        - 전(용): 730 (건폐율 70, 용적률 300)
        - 일(반): 735 (건폐율 70, 용적률 350)
        - 준(공업): 740 (건폐율 70, 용적률 400)
    - 녹지, 관리, 농림, 자연환경보전
...
- 재건축 사업
    - 시행자
        ...
        - 조합의 과반 동의를 받아 시장, 군수, (자치구) 구청장, 특별자치도지사, 주택 공사와 공동으로 시행
    - 개발 대상: 노후, 불량 건축물
    - 법적 상한까지 용적률을 완화받으려면 종전 세대수의 **100분의 160**에 해당하는 세대를 건설, 공급해야함 (**'재건축!, 용적률!' 외쳐서 60% 세대 증가**)
    - 사업 계획서에 포함되어야 할 사항
        - 토지 이용 계획
...
- 다음에 해당하는 경우, 도지사의 사전 승인을 받아야함.
    - 층수가 **21층 이상**이거나, 연면적 합계가 **10만 제곱미터**인 이상인 건축물 (공장, 창고 제외).('층수'(2), '층'(1), '연면적합계이상건축물'(10))

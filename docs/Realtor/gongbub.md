...
- 행정청 내부에서만 효력이 있음.
- 계획 수립
    - 가장 높으신 분들 (도지사, 국토부 장관)이 구역 지정
    - 광역 도시 계획권이 같은 도의 관할 구역
        - 도지사가 광역 계획권 지정
        - 시장 또는 군수가 공동으로 수립후, 도지사가 승인
            - **3년**동안 계획이 없으면 '도지사'(3)가 수립
        - 시장 또는 군수가 요청하는 경우, 도지사가 단독으로 직접 수립하거나 시장,군수와 공동으로 수립
    - 광역 도시 계획권이 둘 이상의 시,도 관할구역
        - 국토부 장관이 광역 계획권 지정
        - 시, 도지사가 공동으로 수립후, 국토부 장관이 승인
            - **3년**동안 계획 수립 없는 경우, '국토부'(3) 장관이 수립
        - 국가계획과 관련된 경우 국토부 장관이 직접 수립
- 내용
...
- (기출) 건폐율, 용적률
    - 주거지역
        ...
        - 2종 일반: 이종 격투기 625 참전용사 (건폐율 60, 용적률 250)
        - 3종 일반: 삼촌 어서 오삼 (53, 건폐율 50, 용적률 300)
        - 준주거: 상업지역으로 바뀌면서 돈 많이 벌어서 BMW 750 (건폐율 70, 용적률 500)
    - 상업지역
        - 중(심): 구 (9) 1500 (교통비 시작)
        - 일(반): 파 (8) 1300
        - (유)통: 발 (8) 1100
        - 근(린): 출 (7) 900
    - 공업지역
        - 전(용): BMW730 (건폐율 70, 용적률 300)
        - 일(반): BMW735 (건폐율 70, 용적률 350)
        - 준(공업): BMW740 (건폐율 70, 용적률 400)
    - 녹지, 관리, 농림, 자연환경보전
        - 기본 2080 (건폐율 20, 용적률 80)
        - 자연(이) 생산(한) 녹지: 200세 까지 산다 (건폐율 20, 용적률 100)
        - (몸무게) 계획 관리: 40kg~100kg 사이에서 관리 (건폐율 40, 용적률 100)
    - 개발진흥지구: 당구 실력 개발을 진흥
        - 도시 외: 400 놓고 친다 (건폐율 40, 용적률 100)
        - 자연녹지: 자연의 무림 고수들이 있으므로 300으로 낮춰서 친다 (건폐율 30, 용적률 100)
    - 수산자원보호구역: 광어는 사팔뜨기 (48, 건폐율 40, 용적률 80)
    - 자연공원: 어르신들이 점600 고스톱 치고 있다 (건폐율 60, 용적률 100)
    - 취락지구: 어르신들이 모여서 환갑잔치 하고 있다 (60, 건폐율 60)
    - 산업단지: 산업단지 내에 사장님들은 g80 타고 다닌다 (건폐율 80)
    - 농공단지: 농대, 공대가면 운(7)을 잃오 (15) (건폐율 70, 용적률 150)
...
- 도시개발구역, 택지개발구역, 경제자유구역, 정비구역이 **200만 제곱미터** 초과시, **공동구** 설치해야함 (일반 산업 단지는 X)
    ...
    - 공동구 관리자는 **5년**마다 안전 및 유지관리 계획을 수립, 시행하여야함.
...
- 도시, 군 계획 시설 사업
    ...
    - 집행 계획 수립후 시행자를 지정함.
        ...
        - 비행정청 시행자 (총 사업비의 20% 범위 내에서 이행보증금을 예치해야함)
            ...
            - 한국 철도 공사
            - 지방 공기업
            - **민간 시행자**로 선정되기 위해서는 토지 (국,공유지 제외) 토지 소유자의 **2분의 1 이상**, 면적의 **3분의 2 이상** 소유하고 동의를 받아야함 (**'시설'(2), '민간'(2), '시행자'(3), 사람이 먼저니까 토지소유자 2분의 1이상, 면적 3분의 2 이상**).
                - 공공 시행자는 동의받지 않아도 됨.
    ...
    - 실시 계획의 고시가 가지는 효력
        ...
        - 고시일로부터 **20년**되는 날의 다음날에 효력을 잃음 (**'시설'(2)**)
        - **10년** 이내에 시행되지 않으면 지목의 '대'인 토지의 소유자는 매수 청구를 할 수 있음 (**매수청구 10-6-2 (열매, '매수여부결정'(6), '매수'(2))**).
            - 단, 실시계획의 인가나 그에 상당하는 절차가 진행된 경우에는 토지 소유자의 매수 청구권이 인정되지 않음.
...
- 의무적 지정 대상
    - 정비구역 및 택지 개발 지구에서 시행되는 사업이 끝난 뒤, **10년**이 지난 지역 (**'정비구역,택지개발지구'(10)**)
    - 다음 지역중 30만 제곱 미터 이상의 지역
        - 시가화 조정 구역 또는 공원에서 해제되어, 녹지 지역으로 지정되지 않고 개발 계획이 수립되는 지역 (**'시가화'(3) 30만 제곱 미터**)
        - 녹지 지역에서 주거지역, 상업지역, 또는 공업지역으로 변경되는 지역  (**'주,상,공' 3개 지역으로 변경되는 지역이므로 30만 제곱미터**)
...
- 지구 단위 계획 구역에서 건축물을 건축 또는 용도 변경하거나 공작물을 설치하려면 지구 단위 계획에 맞게 해야함.
    - **가설건축물**은 해당 안됨.
- 구역이 고시되고 **3년** 이내에 계획이 결정, 고시되지 않으면 실효 (**'무계획'(3)**)
- 계획이 고시되고 **5년** 이내에 사업이나 공사에 착수하지 않으면 실효 (**'공사미착수'(5)**)
...
- 허가 예외 대상
    - 재해 복구나 재난 수습을 위한 응급 조치
        - 응급 조치후, **1개월** 이내에 시장, 군수, 특별 자치 도지사에게 **신고**해야함.
    - 대통령령으로 정하는 경미한 행위
- 절차
    - 신청서 제출시, 용지 확보, 위해 방지, 환경 오염 방지, 경관, 조경 등에 관한 계획서를 허가권자에게 제출해야함.
    - 환경 오염 방지 조치를 할 것을 조건으로 개발행위허가를 하려는 경우, 미리 신청한 자의 의견을 들어야 함.
    - 시장, 군수, 특별 자치 도지사는 도시계획위원회의 심의 또는 기타 협의기간을 제외하고 **15일** 이내에 허가, 불허가 처분 (**l로 딱 긋고, '허가불허가'(5) 처분은 15일**)
...
- 기반 시설 부담 구역: 신 개발지에서 기반시설을 새로 설치해야하는 구역
    ...
    - 기반 시설 설치 비용
        ...
        - 현금, 신용카드 또는 직불카드로 납부하며, **물납도 인정**됨.
        - 기반 시설 부담 구역별로 특별 회계가 설치되어야함.
        - 시장, 군수는 기반시설설치비용 납부의무자가 지방자치단체로부터 건축허가를 받은 날부터 **2개월** 이내에 기반시설설치비용을 '부과'(2)하여야함.
...
- (기출) 개발 행위의 허가시, 토지의 분할 및 물건을 쌓아놓는 행위에 입목의 벌채를 수반하면 안됨.
...
- (기출) 국토교통부장관이 해당 도시 군계획시설에 대한 도시군관리계획 결정권자에게 도시군계획시설결정의 해제를 권고하려는 경우에는 중앙도시계획위원회의 심의를 거쳐야 한다.
- (기출) 토지분할을 위한 개발행위의 허가를 받은 자는 그 개발행위를 마치면 시,도지사의 준공검사를 받지 않는다.

# 도시 개발 사업
- 원칙적으로 계획 수립 후, 구역을 정하나, 다음의 경우 지역을 먼저 정할수 있음 (계획적 개발이 유연하게 필요한 미개발지나 복합 지역)
    - 녹지 지역 (자연 녹지 지역, 생산 녹지 지역)
    - 도시지역 외의 지역
    - 도시 개발 구역으로 지정하려는 지역
    - 도시 개발 구역인데, 주거지역, 상업지역, 공업지역의 면적이 **100분의 30 이하**인 지역 (주,상,공 3개니까 100분의 **3**0 이하)

### 도시 개발 사업의 수용 또는 사용 방식
- 시행자가 **국가나 지방자치단체인 경우 동의 필요 없이 진행 가능**.
- 민간 시행자는 토지 소유자의 2분의 1 이상, 토지 면적의 3분의 2의 동의를 받아야 함 (**'개발'(2), '민간'(2), '시행자'(3), 2분의 1, 3분의 2, 사람이 먼저다**).
- (기출) 도시개발구역 전부를 환지 방식으로 시행하는 도시개발사업을 지방자치단체의 장이 집행하는 공공시설에 관한 사업과 병행하여 시행하는 경우 **국가**는 시행자로 지정될 수 없다.
...
- 환지의 처분
    - 준공 검사 받은후 **60일** 이내에 환지 처분을 해야함 (**검사환지처분(6)**)
    - 환지 계획에서 정해진 환지는 그 환지 처분이 공고된 날의 다음날부터 종전 토지로 봄.
    - 환지를 정하지 않은 종전 토지에 있던 권리는 공고된 날의 다음날부터 소멸
    - 체비지는 시행자가 취득.
    - 보류지는 환지 계획에서 정한 자가 취득.
    - 환지 처분 공고 후 **14일** 이내에 등기 신청 해야함 (**등기는 14천리**)
    ...
    - 청산금
        ...
        - 청산금을 받을 권리나 징수할 권리의 소멸시효는 **5년** (**'청산금소멸'(5)**)
...
- 도지사, 대도시 이상 시장 (그냥 시장은 못함)
    ...
    - 소도시 시장, 군수는 도지사에게, 자치구 구청장은 시장에게 도시개발구역 지정을 요청할 수 있다.
- 국토 교통부 장관
    - 국가가 사업주체인 경우
...
- 도시 개발 구역 지정되어 고시 == '도시 지역'이 되고, 지구 단위 계획 구역으로 결정되어 고시
    ...
    - 도시 개발 구역이 지정, 고시된 날로부터, **2년** 이 되는 날까지 '개발 계획' (2어절)을 수립, 고시하지 않을 경우, **2년**이 되는 다음날, 구역 지정이 해제됨 (**330만 제곱미터 이상은 5년**)
    - 개발 계획을 수립, 고시한 날로부터, **3년** 이 되는 날까지 '실시 계획 인가' (3어절) 를 신청하지 않으면, 3년이 되는 다음날 이전의 용도 지역 및 지구 단위 계획 구역으로 환원됨 (**330만 제곱미터 이상은 5년**).
    - 공사 완료시 해제.
...
- (기출) 지정권자가 시행자가 아닌 경우 도시 개발 구역의 통신시설의 설치는 특별한 사유가 없으면 준공검사 신청일까지 끝내야 한다 (통신시설은 설치하고 검사 받아라)
...
- 환지 방식
    - 토지 소유자: 토지소유자의 **2분의 1 이상**, 토지 면적(국공유지 포함)의 **3분의 2 이상** 동의가 있는 경우 토지 소유자가 시행 가능 (조합 설립시나 민간 시행자를 선정할때와 같은 동의 요건 필요).
    - 조합 (**'도시개발사업은'(7), '토지'(2) 소유자의 2분의1, '총면적'(3)의 3분의2, 국유지 포함, 설인30등기**)
...
- 시행자를 변경할수 있는 경우 (**시행자 노답 - 계획1개도 안세우거나, '착수'(2) 안했을때**)
...
- 시행자는 실시 계획을 작성하고 지정권자의 인가를 받아야함.
    - 지구 단위 계획 포함.
        - 설계도서, 자금계획, 시행기간 등
- (기출) 조합장 또는 이사의 자기를 위한 조합과의 계약이나 소송에 관하여는 **감사**가 조합을 대표한다.
...
- 상환 기간: **5~10년** ('도시개발은'(5)~'도시개발채권상환기간'(10))
- 소멸 시효: 상환일부터 기산하여 **원금 5년, 이자 2년** (원금은 5우원금, 이자니까 2년)
...
- 수립권자: 시장급 (시장, 특별 자치 도지사)
    ...
    - **14일 이상** 주민에게 공람하여 의견을 들어야 한다 (주민 의견은 14천리로 들어야함)
        - (기출) 계획기간 단축의 경우 경미하므로 공람을 아니할 수 있다.
    - 기본계획에는 사회복지시설 및 주민문화시설의 등의 설치계획이 포함되어야 한다.
- 지방의회의 의견 청취를 생략할 수 있는 경우 (실무에서 잦은 경우, 행정상으로 경미한 경우)
...
- 재개발 사업
    ...
    - 토지 등 소유자 분양분 제외한 나머지의 100분의 20 이상 100분의 50 이하의 범위에서 지분형 주택, 공공 임대주택, 공공 지원 민간 임대 주택으로 건설, 공급
        - 지분형 주택: 사업 시행자와 분양 대상자가 주택을 공동 소유로, 주거 전용 면적 **60 제곱 미터** 이하인 주택 ('지분형주택은'(6))
- 재건축 사업
    - 시행자
        - 조합
        - 조합의 과반 동의를 받아 시장, 군수, (자치구) 구청장, 특별자치도지사, 주택 공사와 공동으로 시행
...
### 정비구역의 지정 및 해제
- 권한
    - 정비 기본계획 수립권자, 정비구역 지정권자: 시장급 (시장, 특별 자치 도지사, 단, 광역시의 군수는 제외)
...
- 정비구역의 해제
    - 정비 예정 구역이, 지정 '예정일'(3)로부터 **3년**이 지날 때까지 정비구역의 지정을 신청하지 않은 경우.
    - 토지 등 소유자가 시행하는 재개발 사업에서, 정비구역으로 지정, 고시된 날로부터 **5년**이 되는 날까지 사업 시행 계획 인가를 신청 하지 않은 경우 ('사업 시행 계획 인가 미신청' 5어절)
...
- 재건축 사업의 시행: 관리 처분 계획에 따라 주택, 부대시설, 복리시설 및 오피스텔을 건설하여 공급.
    - 오피스텔을 건설, 공급하는 재건축의 경우, **준주거지역 및 상업지역에서만 가능**하며, 오피스텔은 전체 건축물 연면적의 **100분의 30 이하**이어야 함.
- 재개발, 재건축 사업의 시행
    - 조합이 시행하는 경우 (원칙)
...
- 조합 설립 인가를 위한 동의
    ...
    - 재건축 사업 (**재건축을 하려면 럭키(70%) 해야하며 주택단지가 아닌 지역은 순차적이지 못해서 4332**)
        - 주택단지: 각 동별 과반 동의, 전체 인원의 **70%** 이상, 토지 면적의 **70%** 이상
        - 주택단지가 아닌 지역이 포함된 경우: 전체 인원의 **4분의 3** 이상, 토지 면적의 **3분의 2** 이상
    - 임원: (정비구역에 건축물 또는 토지를 5년 이상 소유) or (정비구역에 거주하고 있으며 선임 직전 3년 중 1년이상 거주)
    - 의회의 소집: '조합원전체'(5) **5분의 1 이상** 또는 '대의원'(3) **3분의 2 이상** 요구가 있을시
    ...
    - 조합원 100인
        - 이하인 경우, **3**명 이상의 이사를 두어야 함.
        - 초과인 경우, **5**명 이상의 이사를 두어야 함.
- (기출) 재개발 사업은 토지 등 소유자가 20인 미만인 경우 직접 시행할 수 있다 (**'토지' 2글자 이므로 20인 미만**)
- (기출) 재건축사업 조합설립추진위원회가 구성승인을 받은 날부터 3년이 되었음에도 조합설립인가를 신청하지 아니한 경우 시장ㆍ군수등이 직접 시행할 수 있다 ('재건축' 3글자, '시장군수 직접 시행' 3어절)
- (기출) 재건축 사업은 토지 등 소유자가 직접 시행할 수 없음 (보통 사람이 많아서 이해관계가 복잡하기 때문)
- 재건축 사업에서 매도 청구
...
- 분양 신청
    - 사업 시행 계획 인가 고시 후, **90일** 이내에 토지 등 소유자에게 다음을 통지해야함 (예외적인 조건에서 30일 연장 가능).
        - 고시가 있은 날 기준 토지 또는 건축물의 가격
        - 분담금 추산액
        - 분양 신청 기간
    - 분양 신청 기간은 통지한 날로 부터 **30일** 이상 **60일 이내** (**20일** 범위에서 한차례 연장 가능 - '분양'(2) 2달)
    - '분양신청하지아니한'(9) 토지등소유자가 있는 경우 사업시행자는 관리처분계획이 인가, 고시된 다음 날부터 **90일** 이내에 그 자와 토지, 건축물 또는 그 밖의 권리의 손실보상에 관한 협의를 하여야 한다.
    - 위 협의가 성립되지 아니하면 사업시행자는 그 기간의 만료일 다음 날부터 **60일** 이내에 수용재결을 신청하거나 '매도청구소송'(6)을 제기하여야 한다.
...
- 관리 처분 계획 인가, 고시의 효과
    - **조합원 5분의 1 이상**이 관리처분계획인가 신청이 있은 날로부터 **15일** 이내에 관리처분계획의 타당성 검증을 요청한 경우, 시장, 군수는 이에 따라야 한다.
    - 처분의 기준: 건설된 건축물을 관리 처분 계획에 따라 토지 등 소유자에게 공급해야함.
    - 건축물의 철거: 관리 처분 계획 인가를 받은 후, 기존 건축물 철거해야함.
    - 사용, 수익 정지: 종전의 토지 또는 건축물의 권리자는 관리 처분 계획 고시가 있으면 이전고시(분양처분) 가 있는 날까지 사용, 수익 할수 없음.
...
- 이전고시
    ...
    - 이전고시가 있은 후, 분양 받은자는 청산금 (종전 가격과 분양가격 차이) 정산을 함.
        ...
        - 청산금을 지급, 징수할 권리는 이전고시일 다음날 부터 **5년**간 행사하지 않으면 소멸 (**청산금소멸 5글자니까 5년**).
- 조합의 정관에서 조직, 사업 계획, 예산, 청산 등의 규정을 정함
    ...
    - (기출) 정관의 기재 사항 변경 시, 시장,군수등의 인가를 받아야 한다.
        - 주요 사항은 '조합원'(3)의 3분의 2 찬성이 필요 (조합원 자격에 관한 사항, 제명/탈퇴/교체, 정비구역의 위치/면적, 비용 관련, 시공 관련)
...
- (기출) 조합원
    ...
    - 조합의 임원이 금고 이상의 형을 선고 받으면 **그 날**부터 임원의 자격을 상실한다 (도시개발에서는 다음날, 정비사업에서는 당일)
- (기출) 토지임대부 분양주택 (부동산 투기에 대한 불혹 - **4**와 연관)
    - 토지는 공공(SH/LH)이 소유하고, 건물만 분양받아 소유하는 주택.
    - 토지에 대한 임대차 기간은 **40년** 이내.
    - 토지에 대한 임대차 기간을 갱신하기 위해서는 토지임대부 분양주택 소유자의 **4분의 3 이상**이 계약갱신을 청구해야한다.
    - 토지임대료를 보증금으로 전환하여 납부하는 경우, 적용되는 이자율은 '은행법'(3)에 따른 은행의 **3년** 만기 정기예금 평균이자율 이상어이야 한다.
...
- (기출) 도시 및 주거환경정비 법령상 주택의 공급
    ...
    - **주택재개발** (재건축 아님) 사업의 시행으로 건설된 임대주택을 조합이 요청하는 경우, 시도지사 혹은 시장, 군수, 구청장이 우선하여 인수하여야하며, 부득이한 사정으로 인수가 어려운 경우 국토교통부장관에게 토지주택공사등을 인수자로 지정할 것을 요청할 수 있다.
    - **주택재개발** (재건축 아님)의 경우, 세입자, 토지등 소유자의 요청이 있는 경우 국토교통부장관은 인수한 임대주택의 일부를 '주택법'에 따른 토지임대부 분양주택으로 전환하여 공급하여야한다.
...
- (기출) 임대주택의 건설, 공급의 혜택
    ...
    - 사업주체는 용적률 완화로 건설되는 임대주택을 인수자에게 공급하여야 하며, **시,도지사**가 우선 인수할 수 있다.
    - 사업주체가 인수자에게 공급하는 경우, 임대주택의 부속토지는 기부채납한 것으로 본다.
    - 용적률을 완화하여 주택을 건설하는 경우, 완화된 용적률의 60퍼센트 이하의 범위의 면적을 임대주택으로 공급하여야 한다.
...
- (기출) 주거환경정비법령상 다음 소규모 토지 등의 소유자의 요청이 있는 경우 재개발 임대주택의 일부를 분양주택으로 전환하여 공급하여야 한다.
    - 면적이 **90** 제곱미터 미만인 토지 소유자 (건축물 X)
    - 바닥면적이 **40**제곱미터의 주거를 위한 건축물 소유자 (토지 X)
...
- 용어
    ...
    - 고층 건축물: 층수 30층 이상 or 120m 이상 ('고오층' 3글자)
    - 초고층 건축물: 층수 50층 이상 or 200m 이상 ('초고층건물' 5글자)
        - '피난 안전 구역'(3어절) 을 최대 30개층 마다 1개소 이상 설치 해야함.
...
- 건축법이 적용되지 않는 건축물
    ...
    - 하천 구역 내의 수문조작실
- 건축물의 용도
    - 단독주택: 단독주택, 다중주택 (3층 이하, 취사 불가, 1개 동이 660 제곱미터 이하, 학생 직장인 대상, 주인 1명), 다가구주택 (3층 이하, 취사 가능, 1개 동이 660 제곱미터 이하, 가구 단위, 주인 1명), 공관 (**공관은 건축법에서는 주택이지만, 주택법에서는 주택이 아니다**)
    - 공동주택: 아파트 (층수가 **5개층** 이상), 연립주택 (1개 동이 660 제곱미터 초과, 층수가 **4개층** 이하), 다세대주택 (1개 동이 660 제곱미터 이하, 층수가 **4개층** 이하), 기숙사
        - 세대구분형 공동주택: 세대별로 구분하여 생활이 가능하되, 그 구분된 공간의 일부를 구분소유할수 없는 주택
            - 신축 세대구분형
                ...
                - 주택단지 공동주택 **전체 호수의 3분의 1**을 넘지 않아야 함.
            - 기존 주택 리모델링형
                - 2세대 이하로 분리해야함.
                - **동별 3분의 1**을 넘지 않아야 함.
                - 주택단지 공동주택 **전체 호수의 10분의 1**을 넘지 않아야 함.
...
- 건축의 종류: 신축, 증축, 개축, 재축, 이전
    - 신축: 나대지에 새 건물을 올리거나 기존 건물을 완전히 철거하고 그 자리에 새로 짓는 경우
    - 증축: 기존 공간을 더 넓고 높게 확장하는 경우
    - 개축: 기존 건축물의 일부 또는 전부(내력벽, 기둥, 보, 지붕틀 중 3개 이상 포함)를 철거하고 종전과 같은 규모로 다시 짓는 것
    - 재축: 개축과 내용은 같으나 철거가 아닌 재해(자연재해, 화재 등)로 건물이 사라졌을 때 적용
    - 이전: 건축물의 주요 구조부를 해체하지 않고 같은 대지 안에서 다른 위치로 옮기는 경우
    - (기출) 건축물의 내력벽을 해체하여 같은 대지의 다른 위치로 옮기는 것: **개축**
- 대수선 ('대수선'(3) 이므로 수선, 변경시 3과 연관됨)
...
- '사전'(2) 결정: 허가권자가 해당 대지의 건축 제한, 고려 사항등을 명시한 내용으로, 건축주는 사전결정 통지를 받은 뒤, 2년 이내에 건축 허가를 신청해야함 (이후엔 효력 상실)
...
- 건축, 대수선 허가의 허가권자: 시장, 군수, (자치구) 구청장, 특별자치도지사
    - 층수가 **21층** 이상이거나, 연면적 합계가 **10만 제곱미터**인 이상인 건축물 (공장, 창고 제외) 을 특별시나 광역시에 건축하려면 특별시장이나 광역시장 허가 필요 (다른 곳에서는 도지사 사전 승인을 받아야 하지만, 특별시나 광역시의 시장은 직접 허가 가능)
- 다음에 해당하는 경우, 도지사의 사전 승인을 받아야함.
    - 자연환경 보호를 위해 '도지사'(3)가 지정한 구역에 **3층** 이상 또는 연면적 합계가 **1천 제곱미터**(자연이니까 천) 이상인 위락시설 및 숙박시설 등 (대통령령에 의한 용도)
    - 주거환경이나 교육환경 보호를 위해 도지사가 지정한 구역에 건축하는 위락시설 및 숙박시설
- 건축주가 '사용승인신청서'(7)를 제출하면 허가권자(지자체)는 **7일 이내**에 현장 검사를 실시하고, 합격한 건축물에 대해 사용승인서를 교부해야함.
- 건축 허가의 필수적 취소
    - 허가를 받고 **2년**간 착공 안한 경우 ('착공'(2)에 2년 줌)
    - 완공이 불가능한 경우
- 국토 교통부 장관이나, 특별시장, 광역시장, 도지사는 건축 허가를 제한할수 있음.
    - 제한 기간은 **2년** 이내 ('제한'(2)에 2년 줌)
    - **1회**에 한하여 **1년 이내**의 범위에서 연장가능.
...
- (기출) 철거
    - 시장, 군수, 구청장, and (특별자치시장, 특별자치도지사)에게 신고해야함.
...
- (기출) 특별건축구역
    ...
    - **도**시혁신구역 또는 **복**합용도구역으로 지정된 지역은 건축법에 따른 '특별건축구역'으로 지정된 것으로 본다. (도복이 특별하다!)
...
- (기출) 특별건축구역에서 건축하는 건축물은 다음을 적용받지 않는다.
    - 조경
    - 건폐율
    - 용적률
    - 공지
...
- 주택단지: 철도, 고속도로, 자동차전용도로, 폭 **20m 이상** '일반'(2)도로, 폭 **8m 이상** '도시계획예정도로'(8) 등으로 분리된 토지.
...
- **정비구역에서는 지역주택조합, 직장주택조합, 리모델링주택조합**을 모집할수 없음 (이익의 충돌)
- 주택 조합 설립 인가
    - 지역주택조합, 리모델링 주택조합, 직장 주택 조합은, 시장, 군수, (자치구) 구청장, 특별자치도지사에게 설립, 변경, 해산시 **인가**를 받아야함.
        - 단 직장 주택 조합이 국민주택을 공급받을때는 '**신고**' 해야함 (회사니까 정부가 터치하지 않음)
    - 지역주택조합, 직장주택조합의 요건 (815)
        - 주택 건설 대지의 **80%** 이상 토지의 사용권원, **15%** 이상의 소유권을 확보해야함.
    - 리모델링 주택조합의 요건 (**'리모델'(3), '각동'(2), '동모델'(3)**)
        - 전체 단지 리모델링: 전체 구분소유자의 3분의 2 이상, 각 동의 과반 이상 동의.
        - 동 리모델링: 해당 동의 구분소유자의 3분의 2이상 동의.
- 지역주택조합 및 직장주택조합의 조합원 모집
...
- 조합원의 자격
    ...
    - 리모델링 주택조합
        - 공동주택의 소유자
        - 복리시설의 소유자
- 주택조합 설립인가를 받은 날로부터 2년 이내(인가==2인가?)에 사업계획승인 혹은 허가를 신청해야함.
...
- 사업 계획 승인권자
    ...
    - (기출) 사업계획승인권자는 사업계획승인의 신청을 받았을 때에는 정당한 사유가 없으면 신청받은 날부터 **60일** 이내에 사업주체에게 승인 여부를 통보하여야한다 (**승인여부통보(6)**)
- (기출) 사업 계획의 승인
...
- 사업 계획의 이행
    - 사업 계획 승인을 받은 날로부터 **5년** 이내에 착공해야함 ('최초착공은'(5))
    - 공구별 분할시행에 따른 사업 계획 승인을 받은 경우
        - 최초 착공 공구: **5년** 이내 ('최초착공은'(5))
        - 다른 공구: 최초 착공 신고일로부터 **2년** 이내 ('다른'(2))
    - 1년 범위에서 착수기간 연장 가능
- 사업주체가 사업계획승인권자에게 착공신고를 한 경우, 승인권자는 **20일** 이내에 신고수리여부를 신고인에게 '통지'(2)해야함
- 사업 계획 승인의 취소
    - 착공 기한내에 착공하지 않은 경우
    - 완공이 어려운 경우
        - 사업 주체가 대지 소유권을 상실한 경우
        - 사업 주체가 부도, 파산한 경우
- 사용 검사는 시장, 군수, 구청장에게 받아야 하며, **15일** 이내에 적합 여부를 확인하여야 한다 (**l로 딱 긋고 '적합부적합'(5) 이니 15**)
- 사용 검사 후, 사업 시행자가 모든 땅을 다 사서 건물을 지었다고 생각했지만, 법적으로 등기 원인이 무효가 되는 등의 반전이 생기는 경우
    - 주택 소유자들은 **시가**로 매도 청구 가능 (형성권).
    - 전체 대지면적의 **5% 미만**이어야함.
        - 넘는 경우 매도 청구 못함.
    - 대표자를 선정하여 '매도청구'(4)에 관한 소송을 하는 경우, 대표자는 복리시설을 포함하여 주택 소유자 전체의 **4분의 3 이상**의 동의를 받아 선정한다.
    - 토지 소유권이 회복되고 **2년** 이내에 매도 청구 의사 표시가 실 소유자에게 '송달'(2)되어야함.
- 주택 상환 사채
    - 한국토지주택공사, '등록사업자'(5) (자본금 **5억** 이상) 는 주택으로 상환하는 기명증권인 사채를 발행할 수 있음.
    - 승인권자: 국토 교통부 장관
    - 상환기간: **3년이내** (사채 발행일 부터 공급 계약 체결일까지의 기간, **주우택(3)**)
...
- 사업주체는 입주자 모집 공고 신청일부터 소유권 이전 등기를 신청할수 있는 날 (입주가능일) 이후 60일까지의 기간동안 다음 행위 금지 ('입주자공고후'(6))
    - 저당권, 가등기담보권
    - 전세권, 지상권, 임차권
    - 매매, 증여
...
- 다음 증서는 양도, 양수 및 이를 목적으로 하는 광고를 해서는 안됨.
    ...
    - 주택을 공급받을 수 있는 증서
        ...
        - 이주대책 대상자 확인서
    - (단, 상속, 저당은 가능)
- 다음 조건을 만족하는 경우, 국토 교통부 장관 또는 시, 도지사는 주거 정책 심의 위원회의 심의를 거쳐 투기 과열 지구를 지정할 수 있음.
    - 직전월 부터 **2개월간**, 해당 지역에서 공급되는 주택의 월평균 청약 경쟁률이 모두 **5대1**을 초과하였거나 국민주택규모 주택 (85 제곱미터 이하) 의 월 평균 청약 경쟁률이 모두 **10대1**을 초과 ('국민주택규모청약경쟁'(10))
...
- 조정대상지역(위축지역)
    - **6개월간** 평균 주택가격상승률이 마이너스 **1%**이하인 지역으로 다음에 해당하는 지역 ('조정대상지역'(6))
        - 조정대상지역직전월부터 소급하여 **3개월** 연속 주택매매'거래량'(3)이 직전연도의 같은 기간보다 **20퍼센트** 이상 '감소'(2)한 지역
        - 조정대상지역직전월부터 소급하여 **3개월**간의 평균 '미분양'(3)주택의 수가 직전연도의 같은 기간보다 **2배** '이상'(2)인 지역
- **국토부장관**은 조정대상지역 (과열지역, 위축지역) 을 주거 정책 심의 위원회의 심의를 거쳐 지정 및 해제할수 있음.
...
- 리모델링
    - 주택법상 리모델링 허가를 받기 위해서는 전체 구분 소유자 및 의결권의 각 **4분의 3** 이상 동의와 각 동별 구분소유자의 **2분의 1**이상 동의를 받아야하며, 동을 리모델링 하는 경우 그 동의 구분소유자의 **4분의 3** 이상의 동의를 받아야 한다.
    - 리모델링 사업은 토지 등 소유자 전원의 동의가 있다면 조합 없이 직접 시행이 가능.
    ...
    - 리모델링 기본 계획
        - 수립, 변경하려면 **14일** 이상 주민에게 공람하고 지방의회의 의견을 받아야 한다 (주민의견은 14천리로 들어야 한다)
        - 지방의회는 30일 이내에 의견을 제시해야한다.
- 토지거래허가
    - 지정권자: 국토교통부장관, 시도지사
        - 국토교통부장관: 토지거래 허가구역이 둘 이상의 시·도 관할구역에 걸쳐 있는 경우
        - 시도지사: 동일한 시·도 안의 일부 지역인 경우
    - 최대 **5년**
    - 불허가 처분 이의 신청: **30일** 이내에 시장, 군수, 구청장에게
    - 허가구역지정 효력: 공고한 날로부터 **5일** 후
...
- 주말, 체험영농을 하려는 자는 **농업진흥지역 외의 농지**를 소유할수 있고, 농지 취득 자격 증명을 발급받아야함.

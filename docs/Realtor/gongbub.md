...
- 도시, 군 계획 시설 사업
    ...
    - 실시 계획의 고시가 가지는 효력
        ...
        - 고시일로부터 **20년**되는 날의 다음날에 효력을 잃음.
        - **10년** 이내에 시행되지 않으면 지목의 '대'인 토지의 소유자는 매수 청구를 할 수 있음 (**매수청구 10-6-2 (열매, '매수청구한다' 6글자, '청구' 2글자)**).
...
### 지구 단위 계획
- (자연인(지구인) 정택 (윤택의 오리지날) 10년, 구역-(3년)-계획-(5년)-착수)
- 국토 교통부 장관, 시장, 군수가 **도시, 군 관리 계획**으로 결정.
- 임의적 지정 대상: 용도지구, 도시개발구역, 정비구역, etc
- 의무적 지정 대상
    - 정비구역 및 택지 개발 지구에서 시행되는 사업이 끝난 뒤, **10년**이 지난 지역
...
- 환지의 처분 (환지니까 **환갑(60), 일사(14)천리로 등기**)
...
- 도시 개발 구역 지정되어 고시 == '도시 지역'이 되고, 지구 단위 계획 구역으로 결정되어 고시
    ...
    - 도시 개발 구역이 지정, 고시된 날로부터, **2년** 이 되는 날까지 개발 계획을 수립, 고시하지 않을 경우, **2년**이 되는날, 구역 지정이 해제됨 (**330만 제곱미터 이상은 5년**)
...
- 환지 방식
    - 토지 소유자 
    - 조합 (**도시개발사업은 7글자**. 과정은 순차적으로 어려워지니 2132 설인30등기**)
...
- 시행자를 변경할수 있는 경우 (**시행자 노답이어서 바꾸는 경우 - 1계획, 2착수**)
...
- 조합 설립 인가를 위한 동의
    ...
    - 조합원 100인
        - 이하인 경우, 3명 이상의 이사를 두어야 함.
        - 초과인 경우, 5명 이상의 이사를 두어야 함.
...
- 리모델링 (15년 지난 주택 대상): 다음 중 하나 (**3-40대가 직장을 잃어(15%)서 잃었삼(15-3), 잃(었)사이(14-2)**)
    - 대수선
    - 각 세대의 주거전용면적의 **30%** (85 제곱미터 이하는 **40%**) 이내 증축 (공용부분도 별도 증축 가능)

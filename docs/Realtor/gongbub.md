...
- 기반 시설 부담 구역: 신 개발지에서 기반시설을 새로 설치해야하는 구역
    ...
    - (**'기반'(2) 이므로 2와 연관, 기는 >1로 쓸 수 있으므로 1년간만 존속**)
    - 시장 이상 (시장, 군수, 특별 자치 도지사) 지정 (도지사 승인 필요 없음)
...
- 환지의 처분 (**검사받은 환갑(60), 일사(14)천리로 등기**)
    - 준공 검사 받은후 **60일** 이내에 환지 처분을 해야함 (**검사 받은 환갑**)
...
- 정비구역의 해제
    ...
    - 조합이 재개발, 재건축을 추진할때 다음의 경우
        ...
        - 추진 위원회가 추진위원회 승인일로부터 **2년**이 되는 날까지 '조합'(2) 설립 인가를 신청하지 않은 경우.
...
- 건축주가 사용승인 신청서를 제출하면 허가권자(지자체)는 **'사용승인신청서'(7)를 7일 이내**에 현장 검사를 실시하고, 합격한 건축물에 대해 사용승인서를 교부해야함.
- 건축 허가의 필수적 취소

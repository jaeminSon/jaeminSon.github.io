...
- 요식 행위: 법률이 정한 방식을 갖추어야 하는 것으로 서면 작성을 필요로함 (e.g. 유언) ↔ 불요식 행위
...
- 부동산 물권의 득실 변경은 **등기** 해야 효력이 생김.
    - 상속, 공용징수 (수용), 형성판결 (이혼 판결, 공유물 분할 판결), 경매, 집합건물의 구조상의 공융부분에 대한 물권의 득실변경, 기타 법률의 규정에 의한 물건 취득은 등기를 요하지 않음. 단, 등기 없이 처분하지 못함.
...
- (기출) 낙약자가 상당한 기간을 정하여 제3자에게 수익 여부의 확답을 최고하였음에도 그 기간 내에 확답을 받지 못한 때에는 제3자가 수익의 의사를 거절한 것으로 본다.

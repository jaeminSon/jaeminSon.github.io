...
- 신탁 등기의 경우, 수탁자가 여러명인 경우, 반드시 합유로 기록해야한다.
...
- 소유권의 저당권은 주기등기, 전세권과 지상권의 저당권은 부기등기한다.
...
- 일정한 금액을 목적으로 하지 않는 채권의 담보를 위한 저당권설정등기신청의 경우 그 채권의 평가액을 신청정보의 내용으로 등기소에 제공해야한다.

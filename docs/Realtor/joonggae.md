...
- 법인
    ...
    - 다음 업무 겸업 가능 (중개보수 규정의 적용은 없음)
        - (조선이 망하고 겸업을 하기 위해 **주상**전하가 **관분** (관리의 대변) 과 **용알** (용의 불X) 을 **경매, 공매**했는데, 영업이 잘 안되서 **경영 기법**에 관한 **상담**을 받았다)
        - 주택, 상가 관리 대행업
...
- 응시 결격자 (취3부5 - 응가시도 결격자: **취**해서 **삼**겹살 먹고 항문 **부**어**오**른 사람)
    - 공인중개사 자격 취소후 **3년** 미만
    - 시험 부정행위자로 **5년** 미만
- 시, 도지사는 합격자 결정 공고일로부터 **1개월** 안에 자격증 교부대장에 기재하고 자격증 교부해야함 (공인중개사 1달 공부하고 따는 사람은 한달 더 기다리면 자격증 받는다).
- 정책 심의 위원회
    - 위원장 1명: 국토교통부 제1차관
    - 위원장 포함하여 7~11명
...
### 중개사무소 등록
- (자립할 나이가 된 손**오천**이 **삼**성에 입사하려는데 특수법인은 **이천** 하이닉스가 낫지 않냐? 라고 핀잔을 주었고, 분사무소는 **이여(2억)~** 하고 칭찬해줬고, 법인은 그 두배 (**4억**)로 감탄하며 **good luck (7)** 을 빌어줌)
...
### 휴업
- (사무실 휴업시 학교에서 분반하는 것 처럼 동업자가 서로 떨어진다 - 분기 이상 휴업은 신고, 반기 이상은 못함)
...
### 중개 계약
- (전속 계약 따면 럭키(7), 삼삼(3-3) 하게 이주일 회 먹을수 있지만, 잘 안되면 독박(100%) 혹은 반독박(50%))
...
### 보증 설정 의무
- (보증을 **공산**주의에서 서주면 돈을 **잃오(15)**)
- 공탁금 회수 제한: 폐업, 사망한 날로부터 **3년** 이내에는 회수할 수 없음.
- 보증금 지급시 호력이 있는 서류: 손해 배상 합의서, 화해 조서, 판결문
- 개업 공인중개사는 손해 배상 이후, **15일** 이내에 재가입 혹은 공탁금 보충 해야함.

### 행정 처분
- (**정지육**! **정일** **취삼** **정제삼** - 김정일은 취한삼, 정제된 삼을 좋아했다)
- (등록 관련 - 사부 미태 직거 감미노)
- (**사부** - **사부**의 **결**심: **중수**를 **3정** 회계법인에 **증정**했다)
- (**미태** - **미달**이의 근무태만: 길게 **휴업**하고, 이중 장부 (**사무실**, **계약서**) 쓰고, 검은돈보정 (**겸금보정**) 하고 **일사(14)**천리로 튀튀 (**22**))
- (**직거** - **직원 결격**: 인터넷에서 **거짓**을 **일삼(13)**고 순위로 치면 **1임등취**)
- (**감미노** - **감**독비협조, **미**등록인장, **노(인,교,통,존)**)
- 처분권자
    - 개업 공인중개사: 등록 관청
    - 공인중개사: 자격증 교부 시,도지사
- 시,도지사는 자격취소처분을 하고 **5일** 이내에 국토교통부 장관과 이전 시,도지사에게 통보해야한다. (**'국토교통부'는 5글자**)
- 개업 공인중개사 등록 취소 혹은 공인중개사 자격 취소를 하기전에는 청문을 거침.
- 등록증, 자격증이 취소되면 **7일** 이내에 반납해야함 (**'자격증반납기한' 은 7글자**).
- 폐업 전 **업무정지**에 해당하는 행위를 해도, 폐업 후 **1년** 지나면 승계가 되지 않는다.
- 폐업 전 **등록취소**에 해당하는 행위를 해도, 폐업 후 **3년** 지나면 승계가 되지 않는다.
- 폐업 전 **업무정지**에 처분을 받은 경우, 처분일로부터 **1년** 간 승계된다.
- 폐업 전 **등록취소**에 처분을 받은 경우, 처분일로부터 **3년** 간 다시 개업할 수 없다.
...
- 3년 이하의 징역 또는 3천만원 이하의 벌금형 (3,3-제일 셈)
    - (개쓰레기가 **거짓 거래 시세조작**으로 공인중개사의 업무를 **방해** 하여 윤**무부**교수의 **직**접 **쌍**욕 횟수가 **급증**했다)
    - 개업 공인중개사의 금지 행위
...
- 1년 이하의 징역 또는 1천만원 이하의 벌금형 (1,1-중간 세기)
    - (**매**, **무뢰**배들이랑 어울리며 **중증**이 되었다 - **거짓된 언행**으로 **사칭**을 하고, **비밀누설**, **보수와 보수 초과**)
    - 개업 공인중개사의 금지 행위
...
### 과태료
- (조선 500년 국운이 다한 경우, 100종원의 사업이 운을 다한 경우)
- 500 만원 이하 (국토교통부 말 안듣고, 운영 규정 안따르고, 교육 안받고, 부당, 불성실, 신분 안밝힐때 - **국운**이 다한 경우는 **부당한 광고**(프로파간다)가 성행하고 **불성실**하고 **교육** 안받고 **신분**도 모르는 사람이 많은 경우이다)
    - 거래 정보 사업자
        - 운영 규정 위반
        - 감독 비협조
    - 정보 통신 서비스 제공자
...
- 100 만원 이하 (TV **증게** 에도 나오던 100종원의 **폐휴업** - **간판** 내리고 **광고** 안하는데, **증반납**을 안해서 사무소만 **이전**하려는 건지 의심된다)
    - 중개사무소 등록증 게시 안한 경우
...
- 징수 기관
    ...
    - 등록 관청: 부당한 표시,광고 및 중개업무 관련 의무를 위반한 개업 공인중개사, 중개보조원 (**부당공보**)
        - (기출) 중개사무소 등록증 미게시 과태료는 등록 관청에서 부과.
- (기출) 과태료에 관한 기준은 대통령령으로 정하고, 업무 정지에 관한 기준은 국토교통부령으로 정한다.

### 거래정보 사업자
- (거래정보 사업자는 IT 기업이라 젊은 직원이 많음 → 오~ 2-30대에게 3월 1일은 설레는 날)
...
- (윤**무부** 교수가 **증**을 보여주면서 꺼지라는 **표시**를 시**세** 관찰 **방해** 하지 말라고 한다)
    - 무등록/부정등록 중개
    - 등록증 또는 자격증 양도, 양수, 대여
...
### 부동산 거래 신고 제출 서류
- (거래신고제출 -> 6글자니까 6억, 수도권은 민감하게 규제해야하니까 하나라도 문제 있으면 안되니 1억)
...
### 부동산 거래 신고의 벌금 및 과태료
- (부동산 거래 신고할때를 생각하면 **33허위**~ **이변부토** **1조치명령**을 내려서 벌금을 때렸다)
- (부동산 거래 신고의 십프로는 거짓이다)
...
- (기출) **종전** 부동산란 (또는 **종전** 토지란) 은 **입주권(재개발, 재건축 입주권) 매매**의 경우에만 작성한다.
    - 분양권(청약당첨)의 경우 적지 않음.
- (기출) 자진신고 하더라도 과태료 감경, 면제 없다.

### 주택 임대차 계약의 신고
- (임대차는 한달 단위로 사니까 신고도 한달 이내, 임대차로 이사한 날에는 육쌈 (**63**), 오이 (**52**))
- 신고 대상
...
- (기출) 대항력을 갖춘 임차인이라도 저당권설정등기 이후 증액된 임차보증금에 관하여는 저당권에 기해 주택을 경락받은 소유자에게 대항할 수 없다.
- (기출) 주택임차인이 상속인 없이 사망한 경우, 해당 주택에서 가정공동생활을 하던 사실혼 배우자는 임차인의 권리와 의무를 단독으로 승계한다.

### 외국인의 부동산 취득
- (60일-300, 6개월-100, 토22: 외국인의 '외'자는 **6**과 닮아있어 60일, 6개월, '외국인'은 3글자이므로 과태료 3백만원, 백만원, 토지는 이이제이)
- 외국인, 외국 법인, 임원 혹은 직원의 과반이 외국인인 법인, 자본금 또는 지분의 과반이 외국인인 법인, 국제 기구
- 매매: 부동산 거래 신고에서와 같이 **30일** 이내에 신고
...
- (기출) 외국인으로부터 토지취득의 허가신청서를 받은 신고관청은 신청서를 받은 날로부터 15일 이내에 허가 또는 불허가 처분을 하여야 한다 (외국인도 내국인과 같이 15일)
...
- 지정된 이후 공고
    ...
    - 공고 대상
        ...
        - 면적 및 용도지역
        - 지형도
- 통지: 시도지사 → 국토교통부장관, 시장,군수,구청장 → 등기소장
- 허가 대상 계약
...
- (기출) 허가 관청은 허가신청서를 받은 날로부터 **15일 ('토허제처분' 5글자 * '처분일' 3글자)** 이내에 허가 또는 불허가 처분을 하여야 한다.
- (기출) 허가구역에 있는 토지에 관하여 사용대차계약을 체결하는 경우에는 토지거래허가를 받을 필요가 없다.
- (기출) 토지거래 허가를 받기 전에 당사자는 매매계약상 채무불이행을 이유로 계약을 해제할 수 **없다**.
...
- 배당 요구의 종기까지 배당 요구를 한 전세권은 매각으로 소멸.
    - 배당 요구를 한 경우, 매수인이 인수해야할 부담이 바뀌는 경우, 배당 요구 철회 못함.
- 유치권, 법정 지상권은 매수인이 인수.
...
- 최고가 매수신고인이 결정되고, 경매 목적물 취득에 증명이나 허가가 필요한 경우 (e.g. 농지 취득 자격 증명) **매각 결정 기일**까지 이를 제출해야함.
    - 불허시 (증명, 허가 미제출, 경매 절차 하자) 새 매각 실시
        - 불허에 **즉시항고**하는 자는 보증으로 매각 대금의 10% 를 공탁하여야하며, **즉시항고**가 기각되는 경우, 공탁한 보증금은 못돌려받음.
            - 즉시항고: '결정', '명령'에 대한 불복 
